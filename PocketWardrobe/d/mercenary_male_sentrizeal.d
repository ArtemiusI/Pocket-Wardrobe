...
++ ~%sent_mercenary_male%~ + sent-mercenary-male-halforc
END
...
++ ~Chain Mail Armor~ + sent-mercenary-male-halforc-1-helmet
++ ~Start over~ + 0
++ ~EXIT~ EXIT
...
~Visible helmet?~
END
++ ~Yes~ DO ~Polymorph(MERCENARY_MALE_HALFORC)~ EXIT
++ ~No~ DO ~Polymorph(MERCENARY_MALE_HALFORC_NOHELM)~ EXIT
++ ~Start over~ + 0
++ ~EXIT~ EXIT
...
~Visible helmet?~
END
++ ~Yes~ DO ~Polymorph(MERCENARY_MALE_HALFORC_1)~ EXIT
++ ~No~ DO ~Polymorph(MERCENARY_MALE_HALFORC_1_NOHELM)~ EXIT
++ ~Start over~ + 0
++ ~EXIT~ EXIT
